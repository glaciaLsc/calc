 ...
 * TODO: Implement infix and prefix functionality
 */
void traverse(struct node* head)
{
	...
	while (current->next != NULL)
	{
		if (strcmp(current->next->data, "+") == 0 || strcmp(current->next->data, "-") == 0 || strcmp(current->next->data, "x") == 0 || strcmp(current->next->data, "/") == 0 || strcmp(current->next->data, "%") == 0)
		{
